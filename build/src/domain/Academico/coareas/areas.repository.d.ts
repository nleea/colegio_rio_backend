...
export interface AreasRepository {
    ...
    storeAreas(body: AreaEntity): Promise<ResponseInterfaces<any> | ErrorsInterfaces<any>>;
    showArea(id: number): Promise<ResponseInterfaces<any> | ErrorsInterfaces<any>>;
    updatedArea(body: AreaEntity, id: number): Promise<ResponseInterfaces<any> | ErrorsInterfaces<any>>;
    showArea(id: number): Promise<ResponseInterfaces<any> | ErrorsInterfaces<any>>;
...
//# sourceMappingURL=areas.repository.d.ts.map